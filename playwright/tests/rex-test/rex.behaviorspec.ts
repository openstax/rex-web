...
test('C543225 canonicals for multi-volumed books point to a single volume', async ({ page, isMobile, browserName }) => {
  ...
  expect(await bookPage.canonical()).toBe('https://openstax.org/books/calculus-volume-1/pages/b-table-of-derivatives')
  ...
  expect(await bookPage.canonical()).toBe('https://openstax.org/books/calculus-volume-3/pages/1-key-concepts')
