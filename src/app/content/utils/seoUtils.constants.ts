...
export const mockBook = {
    ...
    tree: {
        ...
        contents: [
            ...
            {
                id: '4',
                title: '<span class="os-number"><span class="os-part-text">Chapter </span>3</span><span class="os-divider"> </span><span data-type="" itemprop="" class="os-text">Integration Testing</span>',
                slug: '4-integration-testing',
                contents: [],
            },
        ],
    },
