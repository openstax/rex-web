...
export const highlightStyles = [
  {label: 'yellow', passive: '#ffff8a', focused: '#fed200'},
  {label: 'green', passive: '#def99f', focused: '#92d101'},
  {label: 'blue', passive: '#c8f5ff', focused: '#00c3ed'},
  {label: 'purple', passive: '#cbcfff', focused: '#545ec8'},
  {label: 'red', passive: '#ffc5e1', focused: '#de017e'},
];
