...
export const cleanArchiveResponse = <T extends ArchiveContent>(archiveContent: T) => {

  const isBook = (thing: ArchiveContent): thing is ArchiveBook => 'tree' in thing;

  if (isBook(archiveContent)) {
