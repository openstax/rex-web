...
// tslint:disable-next-line:variable-name
const FooterLinkMessage: React.SFC<{id: string, href: string, target?: string, rel?: string }> = ({id, href, target, rel }) => 
<Styled.FooterLink href={href} target={target? target : '_self'} rel={rel? rel : ''}>
  <FormattedMessage id={id}>
    {(msg: Element | string) => msg}
  </FormattedMessage>
</Styled.FooterLink>;
