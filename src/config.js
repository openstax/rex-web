...
let config = {
  ...
  DEPLOYED_ENV: global && global.location ? global.location.hostname : 'server',
  ...
  BOOKS: process.env.REACT_APP_BOOKS || {
    ...
    /* Calculus Volume 1 */ '8b89d172-2927-466f-8661-01abc7ccdba4': {defaultVersion: '6.1'},
    /* Calculus Volume 2 */ '1d39a348-071f-4537-85b6-c98912458c3c': {defaultVersion: '5.1'},
    /* Calculus Volume 3 */ 'a31cd793-2162-4e9e-acb5-6e6bbd76a5fa': {defaultVersion: '5.1'},
