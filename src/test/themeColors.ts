 ...
 * otherwise be generated by different logic than it is checked with.
 *
 * Under src/test/ for the same reason as the engine: test infrastructure rather than
 * app code, so outside jest's `collectCoverageFrom`.
 */
